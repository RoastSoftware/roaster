// Package forwardengineer was generated automatically by inlinesql at 2018-12-16 23:10:01.792631 +0100 CET m=+0.006888501.
...
func GetQueries() []string {
	return []string{
		...
		"create table if not exists user_friends ( username text not null, create_time timestamp with time zone not null, constraint username_fk foreign key (username) references \"user\" (username) match simple on update cascade on delete cascade )",
