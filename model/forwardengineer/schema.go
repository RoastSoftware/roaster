// Package forwardengineer was generated automatically by inlinesql at 2018-12-17 20:20:45.078200432 +0100 CET m=+0.001830577.
...
func GetQueries() []string {
	return []string{
		...
		"create table if not exists user_friends ( username text not null, create_time timestamp with time zone not null, friend text not null, constraint friend_relation_uq unique (username, friend), constraint username_fk foreign key (username) references \"user\" (username) match simple on update cascade on delete cascade )",
