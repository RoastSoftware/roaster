// Package forwardengineer was generated automatically by inlinesql at 2018-12-06 19:07:15.552914975 +0100 CET m=+0.001776349.
...
func GetQueries() []string {
	return []string{
		...
		"create table if not exists \"roast_has_warnings\" ( roast integer not null constraint roast_fk references roast (id), warning uuid not null constraint warning_fk references warning (id) )",
	}
}
