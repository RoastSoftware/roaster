...
`
	...
	errorTests := []model.RoastError{
		{
			RoastMessage: model.RoastMessage{
				Hash:        []uint8{0x23, 0xc2, 0x48, 0x54, 0xd3, 0x6d, 0x59, 0xa1, 0x97, 0x9, 0x6a, 0x66, 0x49, 0xe0, 0x79, 0x3},
				Row:         0x4,
				Column:      0x5,
				Engine:      "flake8",
				Name:        "F821",
		...
		{
			RoastMessage: model.RoastMessage{
				Hash:        []uint8{0x7f, 0x28, 0xcf, 0x1f, 0x79, 0x2, 0x53, 0x5a, 0xbf, 0xe, 0x13, 0xde, 0x24, 0x66, 0xe7, 0x1b},
				Row:         0x6,
				Column:      0x1,
				Engine:      "flake8",
				Name:        "E302",
		...
		{
			RoastMessage: model.RoastMessage{
				Hash: []uint8{0x72, 0xd0, 0xc6, 0xd0, 0xe4, 0x73, 0x50, 0xd0, 0x93, 0x2a, 0xb3, 0x75, 0xc9, 0x8e, 0xd4, 0x5c}, Row: 0x3, Column: 0xe, Engine: "flake8", Name: "W291", Description: "trailing whitespace",
			},
		},
	}
	...
	warningTests := []model.RoastWarning{
		{
			RoastMessage: model.RoastMessage{
				Hash:        []uint8{0x72, 0xd0, 0xc6, 0xd0, 0xe4, 0x73, 0x50, 0xd0, 0x93, 0x2a, 0xb3, 0x75, 0xc9, 0x8e, 0xd4, 0x5c},
				Row:         0x3,
				Column:      0xe,
				Engine:      "flake8",
				Name:        "W291",
		...
		{
			RoastMessage: model.RoastMessage{
				Hash:        []uint8{0xcd, 0xb7, 0xea, 0x70, 0xa7, 0x5d, 0x55, 0x8, 0x80, 0x56, 0xb2, 0x66, 0x92, 0x9e, 0xf8, 0x8},
				Row:         0x6,
				Column:      0x1,
				Engine:      "flake8",
				Name:        "C901",
